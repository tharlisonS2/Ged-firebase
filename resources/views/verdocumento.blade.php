...
<div class="d-flex alt ">
  ...
  <div class=" navl bg-light upload shadow-lg ">
    <div class="w-100 ">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-dark caminho-nav">Salvar</button>
            </div>
            </form>
          </div>
        </div>
      ...
      <ul id="myUL">
        <li class=""><span class="caret px-0 text-primary fs-5" id="campopasta"><a class="text-primary fs-6 " href="/documento/{{$object1->info()['generation']}}">{{$object1->name()}}</a> <button class="btn p-0 w-0 h-0 mx-0" data-toggle="modal" data-target="#myModal-{{$object1->info()['generation']}}"><i class="fa-solid fa-folder-plus p-0 m-0 w-0 h-0" style="color:green;"></i></button></span>
