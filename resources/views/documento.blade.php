...
<div class="listapasta0">
  <div class="listapasta1">
    <div class="treeview w-100 mw-100  treediv">
      ...
      @if($object1->info()["size"]==0 && isset($object1->info()['metadata']['departamento']) && Session::get('departamento')==$object1->info()['metadata']['departamento'])
      ...
      @if($object1->info()["size"]==0 && !isset($object1->info()['metadata']['pai'])&& isset($object1->info()['metadata']['departamento']) && Session::get('departamento')==$object1->info()['metadata']['departamento'])

      <ul id="myUL">
        <li><span class="caret"><i class="far fa-folder-open ic-w mr-1"></i><a href="/documento/{{$object1->info()['generation']}}">{{$object1->name()}}</a></span>
          <button class="btn p-0 w-0 h-0 mx-1" data-toggle="modal" data-target="#myModal-{{$object1->info()['generation']}}"><i class="fas fa-plus-square p-0 m-0 w-0 h-0" style="color:green;"></i></button>
          ...
          <ul class="nested">
            ...
            <li><span class="caret"><i class="far fa-folder-open ic-w mr-1"></i><a href="/documento/{{$objectfilho->info()['generation']}}">{{$objectfilho->name()}}</a></span>
            ...
            <ul class="nested">
              <li><span class="caret"><i class="far fa-folder-open ic-w mr-1"></i><a href="/documento/{{$objectfilho->info()['generation']}}">{{$objectfilho->name()}}</a></span></li>
            <button class="btn p-0 w-0 h-0 mx-1" data-toggle="modal" data-target="#myModal-{{$objectfilho->info()['generation']}}"><i class="fas fa-plus-square p-0 m-0 w-0 h-0" style="color:green;"></i></button>
            </ul>
          ...
          <td>
            <div class="btnicone">
              ...
              <div class="btn-group p-0 mx-1 ">
                ...
                <form action="/visualizar/{{$object->info()['generation']}}" method="POST" name="download">
                  @csrf
